...
namespace Opera_Stable_x64_Launcher
{
    public partial class Form1 : Form 
    {
        ...
        public Form1()
        {
            ...
            {
                case "de":
                    radioButton3.Text = "Das Standard Profil von Opera verwenden";
                ...
                case "ru":
                    ...
                    break;
                default:
                    radioButton3.Text = "Use the standard profile of Opera";
        ...
        private void Button1_Click(object sender, System.EventArgs e)
        {
            ...
            {
                System.IO.File.WriteAllText(applicationPath + "\\Opera Stable x64\\Profile.txt", "--user-data-dir=\"profile\"");
                this.Close();
            }
            if (radioButton2.Checked)
            {
                System.IO.File.WriteAllText(applicationPath + "\\Opera Stable x64\\Profile.txt", "--user-data-dir=\"Opera Stable x64\\profile\"");
                this.Close();
            }
            if (radioButton3.Checked)
            {
                System.IO.File.WriteAllText(applicationPath + "\\Opera Stable x64\\Profile.txt", "");
                this.Close();
            }
        }
    }
